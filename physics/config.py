...
SOLITON_BAL  = 0.5      # min nonlinearity/dispersion ratio for confirmation
...
# ── Shock Front ───────────────────────────────────────────────────────────────
MACH_SHOCK   = 1.4      # Mach threshold — fade anything above this
SHOCK_WINDOW = 8
...
MAE_ATR_FALLBACK    = 1.5   # ATR multiplier for fallback stops
MAE_ATR_PERIOD      = 14
